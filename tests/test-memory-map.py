...
class TestMemoryMap(unittest.TestCase):
    ...
    def test_get_rnmis(self):
        ...
        add_property(cpus[0], "sifive,rnmi-irq-addr = <0x20410000 0xdeadbeef>;")
        add_property(cpus[0], "sifive,rnmi-exception-addr = <0x20420000 0xdeadbeef>;")
        add_property(cpus[1], "sifive,rnmi-irq-addr = <0x20430000 0xdeadbeef>;")
        add_property(cpus[1], "sifive,rnmi-exception-addr = <0x20440000 0xdeadbeef>;")

        rnmis = get_rnmis(cpus)

        self.assertEqual(len(rnmis), 2)
        self.assertEqual(rnmis[0]["id"], 0)
        self.assertEqual(rnmis[0]["irq"]["base_hex"], "0xdeadbeef20410000")
        self.assertEqual(rnmis[0]["irq"]["length_hex"], "0x1000")
        self.assertEqual(rnmis[0]["excp"]["base_hex"], "0xdeadbeef20420000")
        self.assertEqual(rnmis[0]["excp"]["length_hex"], "0x1000")
        self.assertEqual(rnmis[1]["id"], 1)
        self.assertEqual(rnmis[1]["irq"]["base_hex"], "0xdeadbeef20430000")
        self.assertEqual(rnmis[1]["irq"]["length_hex"], "0x1000")
        self.assertEqual(rnmis[1]["excp"]["base_hex"], "0xdeadbeef20440000")
    ...
    def test_get_unique_rnmis(self):
        ...
        add_property(cpus[0], "sifive,rnmi-irq-addr = <0x20410000 0xdeadbeef>;")
        add_property(cpus[0], "sifive,rnmi-exception-addr = <0x20420000 0xdeadbeef>;")
        add_property(cpus[1], "sifive,rnmi-irq-addr = <0x20410000 0xdeadbeef>;")
        add_property(cpus[1], "sifive,rnmi-exception-addr = <0x20420000 0xdeadbeef>;")
